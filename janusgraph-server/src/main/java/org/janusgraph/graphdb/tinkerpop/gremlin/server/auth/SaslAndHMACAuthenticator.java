...
public class SaslAndHMACAuthenticator extends JanusGraphAbstractAuthenticator {
    ...
    private JanusGraphSimpleAuthenticator simpleAuthenticator;
    ...
    public void setup(final Map<String,Object> config) {
        this.simpleAuthenticator = new JanusGraphSimpleAuthenticator();
        this.hmacAuthenticator = new HMACAuthenticator();
        super.setup(config);
